  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-7">
        ...
        {cta.href ? (
          <Button variant={cta.variant === "glow" ? "default" : cta.variant} size="lg" render={<a href={cta.href} />} nativeButton={false}>{cta.label}</Button>
        ) : (
          <Button variant={cta.variant === "glow" ? "default" : cta.variant} size="lg" onClick={cta.onClick}>{cta.label}</Button>
        )}
